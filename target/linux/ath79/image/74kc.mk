...
define Device/teltonika_rut9xx
	...
	$(Device/ar9344)
	DEVICE_MODEL := RUT9XX
	DEVICE_BOOT_NAME := tlt-rut9xx tlt-rut9xx-vboot tlt-rut9xx-vboot-64k
	DEVICE_FEATURES += usb-port gps serial serial-reset-quirk modbus \
			port-mirror io wifi dualsim verified_boot bacnet ntrip mobile
